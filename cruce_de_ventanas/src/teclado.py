...
class MainWindow(QtGui.QMainWindow):
	def __init__(self):
		...
		self.pubCommandP = rospy.Publisher('/cmd_vel',Twist,queue_size=10)
		self.pubLand    = rospy.Publisher('/drone/land',Int8,queue_size = 10)
		self.pubTakeoff = rospy.Publisher('/drone/takeoff',Int8,queue_size = 10)
